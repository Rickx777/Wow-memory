...
void parse_file ( char * filename, 
  ...
  while ( fgets(line, sizeof(line), f) != NULL ) {
	...
	tmp = make_rotZ( theta );
      ...
      scanf(" %lf %lf %lf %lf ", &xvals[0], &yvals[0], &zvals[0], &xvals[1]);
      add_sphere(edges, xvals[0], yvals[0], zvals[0], xvals[1], 0.01);
    }

    else if ( strncmp(line,"torus",strlen(line)) == 0 ){
      scanf(" %lf %lf %lf %lf %lf ", &xvals[0], &yvals[0], &zvals[0], &xvals[1], &xvals[2]);
      add_torus(edges,xvals[0],yvals[0],zvals[0],xvals[1],xvals[2],0.01);
    }

    else if (strncmp(line,"box",strlen(line)) == 0){
      scanf(" %lf %lf %lf %lf %lf %lf ", &xvals[0],&yvals[0],&zvals[0],
	    &xvals[1],&yvals[1],&zvals[1]);
